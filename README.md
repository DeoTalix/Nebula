...
- [Установка на чистую Ubuntu 22.04 при помощи bash скрипта](#установка-на-чистую-ubuntu-2204-при-помощи-bash-скрипта)
